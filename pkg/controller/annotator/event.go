...
func newEventController(c *Controller) *eventController {
	...
	return &eventController{
		Controller: c,
		queue:      workqueue.NewRateLimitingQueueWithConfig(eventRateLimiter, workqueue.RateLimitingQueueConfig{Name: "EVENT_event_queue"}),
	}
}
...
func (e *eventController) handles() cache.ResourceEventHandler {
...
func (e *eventController) handleUpdateEvent(old interface{}, new interface{}) {
